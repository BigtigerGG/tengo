...
func Test_builtinDelete(t *testing.T) {
	var builtinDelete func(ctx context.Context, args ...tengo.Object) (tengo.Object, error)
...
func Test_builtinSplice(t *testing.T) {
	var builtinSplice func(ctx context.Context, args ...tengo.Object) (tengo.Object, error)
	for _, f := range tengo.GetAllBuiltinFunctions() {
		if f.Name == "splice" {
...
func Test_builtinRange(t *testing.T) {
	var builtinRange func(ctx context.Context, args ...tengo.Object) (tengo.Object, error)
	for _, f := range tengo.GetAllBuiltinFunctions() {
		if f.Name == "range" {
